export const lighthouseResults100 = {
    Performance: {
...
export const lighthouseResults50 = {
    Performance: {
        title: 'Performance category',
        score: 0.5,
        description: 'The performance description',
